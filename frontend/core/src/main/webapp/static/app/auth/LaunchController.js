...
function LaunchController($scope, AuthenticationService, AnalyticsService, BackendClientService) {
...
LaunchController['$inject'] = ['$scope', 'AuthenticationService', 'AnalyticsService', 'BackendClientService'];
