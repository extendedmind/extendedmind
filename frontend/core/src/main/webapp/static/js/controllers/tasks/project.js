...
function ProjectController($location, $scope, $routeParams, date, errorHandler, filterService, itemsArray, notesArray, tagsArray, tasksArray, tasksRequest, tasksResponse, userPrefix) {
