...
( function() {'use strict';
    ...
    angular.module('em.directives').directive('mySwipe', ['swiper',
    function(swiper) {
      return {
        restrict : 'A',
    ...
    angular.module('em.directives').directive('tasks', ['swiper',
    function(swiper) {
      return {
        restrict : 'A',
    ...
    angular.module('em.directives').directive('notes', ['swiper',
    function(swiper) {
      return {
        restrict : 'A',
