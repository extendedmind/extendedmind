...
def raze_fetch_remote_crates():
    ...
    maybe(
        ...
        commit = "a12fce08da98cc8475f2a90a45973abcbb94cc1a",
    ...
    maybe(
        ...
        commit = "0bfb994cfd93c1ab09f8e5094f4b86d36b41b272",
    ...
    maybe(
        ...
        build_file = Label("//third_party/cargo/remote:BUILD.num_cpus-1.14.0.bazel"),
    )
