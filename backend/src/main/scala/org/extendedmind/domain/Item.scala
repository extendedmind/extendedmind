...
case class PublicOwnerItemHeader(uuid: UUID, path: String, title: String, licence: Option[String], assigneeName: Option[String], commonTags: Option[scala.List[UUID]], published: Long, modified: Long)
