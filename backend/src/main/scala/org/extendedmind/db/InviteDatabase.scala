      ...
      implicit neo =>
        ...
        if (inviteRequestResponse.isLeft) Left(inviteRequestResponse.left.get)
          ...
          if (inviteRequestQueueNumberResponse.isLeft) Left(inviteRequestQueueNumberResponse.left.get)
            ...
            Some(inviteRequestResponse.right.get)))
        }
    }
  }
