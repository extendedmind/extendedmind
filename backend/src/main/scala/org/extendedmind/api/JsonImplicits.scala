...
object JsonImplicits extends DefaultJsonProtocol {
  ...
  implicit val implPublicOwnerItemHeader = jsonFormat3(PublicOwnerItemHeader.apply)
  implicit val implPublicOwnerStats = jsonFormat3(PublicOwnerStats.apply)
  implicit val implPublicStats = jsonFormat2(PublicStats.apply)
