...
object JsonImplicits extends DefaultJsonProtocol {
  ...
  implicit val implExtendedItemRelationships = jsonFormat5(ExtendedItemRelationships.apply)
  ...
  implicit val implList = jsonFormat12(List.apply)
  ...
  implicit val implPublicItems = jsonFormat8(PublicItems.apply)
  implicit val implPublicItem = jsonFormat4(PublicItem.apply)
