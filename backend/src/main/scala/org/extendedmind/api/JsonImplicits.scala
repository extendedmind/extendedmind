...
object JsonImplicits extends DefaultJsonProtocol {
  ...
  implicit val implSignUp = jsonFormat6(SignUp.apply)
  ...
  implicit val implVisibility = jsonFormat3(SharedItemVisibility.apply)
  ...
  implicit val implNote = jsonFormat14(Note.apply)
  ...
  implicit val implCollective = jsonFormat12(Collective.apply)
  implicit val implUserPreferences = jsonFormat2(UserPreferences.apply)
  implicit val implUser = jsonFormat13(User.apply)
  ...
  implicit val implPublicItems = jsonFormat3(PublicItems.apply)
  implicit val implPublicItem = jsonFormat3(PublicItem.apply)
