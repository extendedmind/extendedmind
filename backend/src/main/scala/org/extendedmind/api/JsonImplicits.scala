...
object JsonImplicits extends DefaultJsonProtocol {
  ...
  implicit val implSharedItemVisibility = jsonFormat11(SharedItemVisibility.apply)
  ...
  implicit val implOwnerPreferences = jsonFormat3(OwnerPreferences.apply)
  implicit val implCollective = jsonFormat17(Collective.apply)
  implicit val implAssignee = jsonFormat3(Assignee.apply)
  ...
  implicit val implStatistics = jsonFormat3(Statistics.apply)
  ...
  implicit val implPublishNoteResult = jsonFormat5(PublishNoteResult.apply)
  implicit val implPublicOwnerItemHeader = jsonFormat9(PublicOwnerItemHeader.apply)
  implicit val implPublicOwnerStats = jsonFormat5(PublicOwnerStats.apply)
  implicit val implPublicStats = jsonFormat3(PublicStats.apply)
  implicit val implPublicItems = jsonFormat13(PublicItems.apply)
  implicit val implPublicItem = jsonFormat7(PublicItem.apply)
  ...
  implicit val implPlatformVersionInfo = jsonFormat8(PlatformVersionInfo.apply)
  implicit val implVersionInfo = jsonFormat2(VersionInfo.apply)
  implicit val implInfo = jsonFormat6(Info.apply)
